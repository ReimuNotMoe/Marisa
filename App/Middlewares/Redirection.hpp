...
#ifndef MARISA_APPMW_REDIRECTION_HPP
#define MARISA_APPMW_REDIRECTION_HPP
...
namespace Marisa::Application::Middlewares {
	...
	public:
		...
		std::unique_ptr<Middleware> New() const override {
			return std::make_unique<Redirection>(location, status_code);
		}
	};
}


#endif //MARISA_APPMW_REDIRECTION_HPP
