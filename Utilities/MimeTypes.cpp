...
std::unordered_map<std::string, std::string> Utilities::mime_types = {
	{"3ds", "image/x-3ds"},
	{"3g2", "video/3gpp2"},
	{"3ga", "video/3gpp"},
	{"3gp2", "video/3gpp2"},
...
const std::string &Utilities::get_mime_type(std::string __file_ext) {
	for (auto &it : __file_ext) {
		it = tolower(it);
	}

	auto it = mime_types.find(__file_ext);
